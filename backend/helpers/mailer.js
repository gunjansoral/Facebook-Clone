...
const { MAILING_ID, MAILING_REFRESH, MAILING_SECRET, EMAIL, MAILING_ACCESS } = process.env
...
exports.sendVerificationEmail = async (email, name, url) => {
    ...
    const mailOptions = {
        ...
        html: `<div style="max-width:700px;margin-bottom:1rem;display:flex;align-items:center;gap:10px;font-family:Roboto;font-weight:600;color:#3b5998">
            <img src="https://res.cloudinary.com/gunjansoraldev/image/upload/v1659539342/logo_prirw7.png" alt="" style="width:30px" >
            <span>Action required: activate your facebook-clone acount</span>
        </div >
        <div style="padding:1rem 0;border-top:1px solid #e5e5e5;border-bottom:1px solid #e5e5e5;color:#141823;font-size:17px;font-family:Roboto">
            ...
            <div style="padding:20px 0">
                <span style="padding:1.5rem 0">
                    You recently created an account on facebook. To complete your registration, please comfirm your account.
                </span>
            </div>
            ...
            <br>
                <div style="padding-top:20px">
                    <span style="margin:1.5rem 0;color:#898f9c">
                        ...
                        registered on facebook, you can share photos, organize events and much more.
                    </span>
                </div>
        </div>`
    }
...
exports.sendResetCode = async (email, name, code) => {
    ...
    const mailOptions = {
        from: EMAIL,
        to: email,
        subject: 'reset Facebook-clone password',
        html: `<div style="max-width:700px;margin-bottom:1rem;display:flex;align-items:center;gap:10px;font-family:Roboto;font-weight:600;color:#3b5998">
            <img src="https://res.cloudinary.com/gunjansoraldev/image/upload/v1659539342/logo_prirw7.png" alt="" style="width:30px" >
            <span>Action required: activate your facebook-clone acount</span>
        </div >
